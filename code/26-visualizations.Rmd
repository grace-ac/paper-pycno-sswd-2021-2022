...
Example, PSC.## would be changed to Adult.Control 
```{r}
expABcounts_transpose$Sample_ID <- gsub("PSC.19", "Adult.Control
```
...
p <- autoplot(pca, data = expABcounts_transpose, colour = 'Sample_ID')
