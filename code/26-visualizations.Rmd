...
# Basic barplot
p <- ggplot(data=top9, aes(x=Count, y=Term, fill=Benjamini)) +
...
```{r}
rates <- c(79.46, 80.32, 74.91, 83.37, 78.12, 78.81, 80.71, 77.36, 77.95, 77.85, 79.39, 46.60, 79.14, 63.35, 77.74, 81.64, 80.67, 77.98, 74.86, 77.80, 78.29, 80.51, 73.65, 73.47, 78.04, 80.29, 78.41, 80.88)
```
...
```{r}
standarderror <- sd(rates)/sqrt(length(rates))
```
