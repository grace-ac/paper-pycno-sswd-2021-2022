...
Now save the table as a figure: 
```{r}
# Save the table as a Word document
save_as_image(x = my_table, path = "../analyses/26-visualizations/Table1_genes_functionalgroups.png", width = 6, height = 4, units = "in", res = 300)
```
Save 2026-06-14
