...
plot_data <- plot_data +
  annotate("point", x = as.POSIXct(sample_dates[13,2]), y = 38, size = 1, colour = "black") + #78
  annotate("point", x = as.POSIXct(sample_dates[11,2]), y = 35, size = 1, colour = "black") + #75
  annotate("point", x = as.POSIXct(sample_dates[6,2]), y = 32, size = 1, colour = "black") + #71
  annotate("point", x = as.POSIXct(sample_dates[7,2]), y = 29, size = 1, colour = "black") + #67
  annotate("point", x = as.POSIXct(sample_dates[1,2]), y = 26, size = 1, colour = "black") + #59
  annotate("point", x = as.POSIXct(sample_dates[8,2]), y = 23, size = 1, colour = "black") + #69
  annotate("point", x = as.POSIXct(sample_dates[2,2]), y = 20, size = 1, colour = "black") + #57
