...
-g ../analyses/03-hisat2/gene_count_matrix.csv \
-t ../analyses/03-hisat2/transcript_count_matrix.csv
```

```{bash}
head ../analyses/03-hisat2/*matrix.csv
```

### write out the gene count and the transcript count matrices to data folder
