...
Write out differentially expressed gene list: 
```{r}
write.table(blastdeg2022counts, "../data/2022_DEG_DET_lists/DEGlist_2022_noage_contrast_counts_BLAST.tab", sep = '\t', row.names = T, quote = F)
```
comment out the code - wrote out 2024-09-18
...
Write out differentially expressed gene list: 
```{r}
#write.table(blastdegagecounts, "../data/2022_DEG_DET_lists/DEGlist_2022_agecontrast_counts_BLAST.tab", sep = '\t', row.names = T, quote = F)
```
comment out the code - wrote out 2024-09-18
