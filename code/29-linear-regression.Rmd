...
```{r}
plot(diameter.data$diameter.cm, diameter.data$days.to.death, pch = 16, cex = 1.3, xlab = "Sea Star Diameter (cm)", ylab = "Days to Death", col=ifelse(diameter.data$diameter.cm<20, "green", "purple"))
