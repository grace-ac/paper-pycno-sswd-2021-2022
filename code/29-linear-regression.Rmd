...
```{r}
plot(diameter.data$diameter.cm, diameter.data$days.to.death, pch = 16, cex = 1.3, xlab = "Sea Star Diameter (cm)", ylab = "Days to Death", col=ifelse(diameter.data$diameter.cm<20, "purple", "orange"))
abline(model.lm, col = 4, lwd = 3)
```


Then... i downloaded image, and added opaque orange (30cm +) and purple (<20cm) to show juves vs adults - in analyses folder for this 
