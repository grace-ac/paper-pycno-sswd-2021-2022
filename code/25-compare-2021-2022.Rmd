...
https://stackoverflow.com/questions/35923311/match-find-rows-based-on-multiple-required-values-in-a-single-row-in-r 


```{r}
shareden2122 <- shared2122 %>% filter(uniprot_accession.x  top9$uniprot_accession)
head(shareden2122)
```


>>>>>>> 78351d252dc0a04b52d1ce88c93628ec41067f01
